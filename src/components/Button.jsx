...
// Reusable button component with variants, dark mode support, and responsive design
const Button = ({ 
  children, 
  variant = 'primary', 
  size = 'md',
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 rounded-lg';
