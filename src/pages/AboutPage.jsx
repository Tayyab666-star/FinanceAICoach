...
import { Users, Award, Globe, Target, CheckCircle, Mail, Shield } from 'lucide-react';
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-24 bg-gradient-to-br from-purple-600 to-blue-600 text-white">
