...
// Quick action card component with navigation - FIXED
const QuickActionCard = ({ title, description, icon: Icon, color = 'blue', path }) => {
  ...
  return (
    <Card 
      className="p-4 hover:shadow-lg transition-all duration-200 cursor-pointer hover:scale-105 transform" 
      onClick={handleClick}
    >
      <div className="flex items-center space-x-3">
        <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
          ...
          color === 'orange' ? 'bg-orange-100 dark:bg-orange-900/50' : 'bg-gray-100 dark:bg-gray-700'
        }`}>
          <Icon className={`w-6 h-6 ${
            color === 'blue' ? 'text-blue-600 dark:text-blue-400' :
            color === 'green' ? 'text-green-600 dark:text-green-400' :
            color === 'purple' ? 'text-purple-600 dark:text-purple-400' :
            color === 'orange' ? 'text-orange-600 dark:text-orange-400' : 'text-gray-600 dark:text-gray-300'
          }`} />
        </div>
...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Quick actions with working navigation - ENHANCED */}
      <Card>
        <div className="p-6">
