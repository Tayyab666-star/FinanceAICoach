  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
      <Card className="w-full max-w-md m-4">
        ...
        <p className="text-gray-600 mb-4">Contributing to: <strong>{goal?.title}</strong></p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="p-4 text-center">
          <h3 className="text-sm font-medium text-gray-600 mb-1">Total Progress</h3>
          <p className="text-2xl font-bold text-gray-900">{overallProgress.toFixed(1)}%</p>
          <p className="text-xs text-gray-500">${totalCurrentAmount.toLocaleString()} of ${totalTargetAmount.toLocaleString()}</p>
        </Card>
        
        <Card className="p-4 text-center">
          <h3 className="text-sm font-medium text-gray-600 mb-1">Remaining</h3>
          <p className="text-2xl font-bold text-blue-600">${(totalTargetAmount - totalCurrentAmount).toLocaleString()}</p>
        </Card>
      </div>
      ...
      {goals.length > 0 ? (
        ...
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">Start by creating your first financial goal to track your progress.</p>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h4 className="font-medium text-blue-900 mb-2">Set Realistic Deadlines</h4>
            <p className="text-sm text-blue-800">Choose achievable timeframes to maintain motivation and avoid disappointment.</p>
          </div>
          
          <div className="p-4 bg-green-50 rounded-lg">
            <h4 className="font-medium text-green-900 mb-2">Break Down Large Goals</h4>
            <p className="text-sm text-green-800">Divide big goals into smaller milestones to track progress more effectively.</p>
          </div>
          
          <div className="p-4 bg-purple-50 rounded-lg">
            <h4 className="font-medium text-purple-900 mb-2">Regular Contributions</h4>
            <p className="text-sm text-purple-800">Make consistent contributions, even small ones, to build momentum.</p>
          </div>
        </div>
      </Card>
